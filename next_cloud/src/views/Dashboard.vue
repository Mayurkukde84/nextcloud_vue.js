...
export default {
  mounted() {
    ...
    Promise.all([
      ...
      loadScript("https://cdn.jsdelivr.net/npm/lodash/lodash.min.js"),
      loadScript("https://cdn.jsdelivr.net/npm/apexcharts/dist/apexcharts.min.js"),
      loadScript("https://cdn.jsdelivr.net/npm/preline/dist/helper-apexcharts.js"),
      loadScript("https://www.googletagmanager.com/gtag/js?id=G-B73TDMXKF5"),
    ])
    .then(() => {
      // Safe to use ApexCharts or Preline here
